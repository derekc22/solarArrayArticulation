...
class Servo:
    def __init__(self, SERVO_PIN):
        ...
        self.coord_file = open("servo_coords.csv", "w+")  # Create file for logging movement data
    ...
    def plotData(self):
        ...
        data = np.loadtxt('servo_coords.csv', delimiter=',')
        ...
        plt.savefig("servo_coords_plt.pdf")
        plt.show()
...
if __name__ == "__main__":
    ...
    servo1 = Servo(3)  # Create servo instance on pin 3
    rand_angle = randint(-180, 181)  # Generate random test angle
    servo1.moveFast(rand_angle)  # Move to test angle
